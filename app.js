...
let limars = document.querySelector("#limars");
...
moon.addEventListener('click',() => {
    ...
    limoon.style.borderBottom="1px solid #FFFFFF"
    limars.style.borderBottom="none";
    lieuropa.style.borderBottom="none";
    lititan.style.borderBottom="none";
...
mars.addEventListener('click',() => {
    ...
    limoon.style.borderBottom="none";
    limars.style.borderBottom="1px solid #FFFFFF";
    lieuropa.style.borderBottom="none";
    lititan.style.borderBottom="none";
...
europa.addEventListener('click',() => {
    ...
    limoon.style.borderBottom="none";
    limars.style.borderBottom="none";
    lieuropa.style.borderBottom="1px solid #FFFFFF";
    lititan.style.borderBottom="none";
    imgplanetmoon.style.display="none";
    imgplanetmars.style.display="none";
...
titan.addEventListener('click',() => {
    ...
    limars.style.borderBottom="none";
    lieuropa.style.borderBottom="none";
    lititan.style.borderBottom="1px solid #FFFFFF";
    imgplanetmoon.style.display="none";
    imgplanetmars.style.display="none";
    imgplaneteuropa.style.display="none";
